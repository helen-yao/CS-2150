...
; Return type is void (rdi, rsi, rdx, rcx, r8, r9)
; general idea: find middle (l+(r-l)/2), call merge on first and second half and then call merge
mergeSort:
	cmp rdx, rsi
	jle done
	...
	shr r10, 1		;middle value

	push rsi
	push rdx
	push r10
	mov rdx, r10		;change right value to m
	call mergeSort
	pop r10
	pop rdx
	pop rsi
